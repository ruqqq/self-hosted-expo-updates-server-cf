...
export const uploads = sqliteTable('uploads', {
  ...
  project: text('project').notNull().references(() => apps.id, { onDelete: 'cascade' }),
  ...
  projectVersionChannelIdx: index('uploads_project_version_channel_idx')
    .on(table.project, table.version, table.releaseChannel, table.status),
  // Index for listing uploads by project
  projectCreatedIdx: index('uploads_project_created_idx')
    .on(table.project, table.createdAt),
}))
...
export const clients = sqliteTable('clients', {
  ...
  projectPlatformIdx: index('clients_project_platform_idx')
    .on(table.project, table.platform),
  // Index for finding active clients
  lastSeenIdx: index('clients_last_seen_idx')
    .on(table.lastSeen),
}))
