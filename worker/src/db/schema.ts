...
export const uploads = sqliteTable(
  "uploads",
  {
    ...
    // Pre-signed manifest for client-side code signing
    // Generated by publish script with developer's private key
    signedManifest: text("signed_manifest"), // Full manifest JSON
    manifestSignature: text("manifest_signature"), // sig="...", keyid="main"
